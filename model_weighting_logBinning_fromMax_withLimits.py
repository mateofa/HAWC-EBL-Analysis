...
path_to_weights_file = '/Users/mateo/Documents/HAWC/EBL/EBLmodel_likelihood/mrk501_gp_SSC_ECPL_EBL_loglike_Fixed_FullRange_12knots_1nuI_50nuI_100um/low'
...
output_plot = os.path.join(path_to_weights_file,'SED_limits_FromMax.png')
...
hist_array[0].Draw('h')
legend.AddEntry(graph_array[0],"68% containment region")
output_plot_2 = os.path.join(path_to_weights_file,'histograms_fromMax.png')

legend.AddEntry(graph_array[0],"68% containment region")
output_plot_3 = os.path.join(path_to_weights_file,'histograms_selection.png')
