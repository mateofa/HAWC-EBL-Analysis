...
hist_array=[]
hist = TH1F('hist', 'Intensity', 50, 1, 32)
...
for l in range(len(lamb)):
	...
	#print hist_name	
	hist = TH1F(hist_name, hist_name, 50, 1, 32)
...
## Create array
f_results=open('/home/mateo/Documents/HAWC/EBL/EBLmodel_likelihood/mrk421_gp_SSC_ECPL_EBL_loglike_Fixed_ZOOM/Model_BIC_Categories_Ordered_ProbValues.txt', 'r')
...
high_bound_05_spline = spline(lamb,high_bound_05,lamb_new, kind='smoothest')
low_bound_05_spline = spline(lamb,low_bound_05,lamb_new, kind='smoothest')

high_bound_16_spline = spline(lamb,high_bound_16,lamb_new, kind='smoothest')
low_bound_16_spline = spline(lamb,low_bound_16,lamb_new, kind='smoothest')
