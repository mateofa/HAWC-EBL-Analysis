...
#DEFINE PATHS!!!
path_to_intensity_file = '/home/mateo/Documents/HAWC/EBL/EBLmodel_likelihood/mrk501_gp_SSC_ECPL_EBL_loglike_Fixed_FullRange/'
path_to_weights_file = '/home/mateo/Documents/HAWC/EBL/EBLmodel_likelihood/mrk421_gp_SSC_ECPL_EBL_loglike_Fixed_FullRange/median'
...
namewithdir_int = os.path.join(path_to_intensity_file,'EBLintensities_lambda24_1_300um_logScale_FULLRANGE_1nuI_30nuI_1e4Extraction.dat')
...
lamb= np.logspace(np.log10(1),np.log10(500),nlambda, endpoint=True)
...
namewithdir_lambWeig = os.path.join(path_to_intensity_file,'intensityweights_lambda24_1_300um_logScale_FULLRANGE_1nuI_30nuI.root')
...
lamb_new= np.logspace(np.log10(1),np.log10(500),1000, endpoint=True)
...
log10x = np.linspace(np.log10(1),np.log10(500),1000,endpoint=True)
x = 10.**log10x
