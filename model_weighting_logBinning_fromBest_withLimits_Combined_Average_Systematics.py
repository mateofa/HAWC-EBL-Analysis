...
path_to_weights_file_421 = '/Users/mateo/Documents/HAWC/EBL/EBLmodel_likelihood/mrk421_gp_SSC_ECPL_EBL_loglike_Fixed_FullRange_12Knots_1nuI_50nuI_100um/Systematics/config_run007578_detRes-GP-allDecs_5deg'
path_to_weights_file_501 = '/Users/mateo/Documents/HAWC/EBL/EBLmodel_likelihood/mrk501_gp_SSC_ECPL_EBL_loglike_Fixed_FullRange_12Knots_1nuI_50nuI_100um/Systematics/config_run007578_detRes-GP-allDecs_5deg'
output_path = '/Users/mateo/Documents/HAWC/EBL/EBLmodel_likelihood/mrkCombined_gp_SSC_ECPL_EBL_loglike_Fixed_FullRange_12Knots_1nuI_50nuI_100um/Systematics'
...
namewithdir_results = os.path.join(output_path,'UpperLower_Limits_Average_PMTeff_run007578_Latex.dat')
...
for i in range(len(lamb)):
	...
	print >> f_results, round(lamb[i],2)," & ",Intensity_best[i]," & ",round(low_bound_68[i],2)," & ",high_bound_68[i]," & ",low_bound_95[i]," & ",high_bound_95[i], " \\\\"

namewithdir_results = os.path.join(output_path,'UpperLower_Limits_Average_PMTeff_run007578.dat')
f_results=open(namewithdir_results, 'w+')
...
plt.plot(lamb,Intensity_best,linestyle = 'None', marker='o', markerfacecolor='red', markersize=6,label='Combined Intensity' )
legend = TLegend(0.1,0.8,0.4,0.9)

ax.legend(loc=5)
plt.legend(fontsize='x-small', ncol=2)
plt.ylim([0, 100])
output_plot = os.path.join(output_path,'SED_limits_FromBest_Average_PMTeff_run007578.png')
...
for i in range(len(lamb)):
	...
	#legend.Draw('same')
output_plot_2 = os.path.join(output_path,"histograms_fromBest_Average_PMTeff_run007578.png")
